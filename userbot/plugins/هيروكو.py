...
async def variable(var):
    ...
    if exe == "جلب":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(
                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝐉𝐀𝐊𝙏𝙃𝙊𝙉 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        if variable in heroku_var:
            await ics.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت جـاكثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
