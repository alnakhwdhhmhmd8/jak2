...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس جـاكثون
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐉𝐀𝐊**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐉𝐀𝐊**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐉𝐀𝐊 - [𝘿𝙀𝙑](t.me/xvwwvl) 𓆪"
)
...
⫷ بوت جـاكثون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @xvwwvl - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @wwvvwl - تحياتي : زلـزال الهيبـه ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين جـاكثون ⫸',
    '⫷ اكتمل تنزيل انلاين جـاكثون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت جـاكثون ⫸',
    '⫷ اكتمل بدء بوت جـاكثون ⫸'
]
