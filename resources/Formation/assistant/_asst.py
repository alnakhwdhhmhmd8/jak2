...
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@xvwwvl"
...
asst_c += "➥ **Copyright** : By [𝐉𝐀𝐊𝙏𝙃𝙊𝙉](https://github.com/xvwwvl)\n"
asst_c += "[Assistant By ](https://t.me/xvwwvl)"
...
SetDec = "- 𝐉𝐀𝐊𝙏𝙃𝙊𝙉 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @xvwwvl 𖤨"
SetAbt = "- 𝙎𝙊𝙐𝙍𝘾𝙀 𝐉𝐀𝐊𝙏𝙃𝙊𝙉 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"
